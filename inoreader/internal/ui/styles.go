...
var (
	...
	selGutterStyle, feedTagStyle, titleStyle, titleSelStyle              lipgloss.Style
	timeStyle, textStyle, linkStyle, readStyle                           lipgloss.Style
)
...
func setTheme(isDark bool) {
	...
	feedTagStyle = lipgloss.NewStyle().Foreground(subtle)
