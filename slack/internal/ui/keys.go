...
func (k keyMap) detailShortHelp() []key.Binding {
	...
	return []key.Binding{k.Up, k.Down, expand, k.ToggleBody, k.React, k.Carbonyl, k.OpenURL, k.CopyURL, k.Back, k.Mark, k.Help, k.Quit}
}

func (k keyMap) fullHelp() [][]key.Binding {
	return [][]key.Binding{
		{k.Up, k.Down, k.Top, k.Bottom},
		{k.Open, k.ToggleBody, k.React, k.Carbonyl, k.CarbonylGfx, k.OpenURL, k.CopyURL, k.Back, k.Mark, k.Refresh},
		{k.Help, k.Quit},
	}
}
